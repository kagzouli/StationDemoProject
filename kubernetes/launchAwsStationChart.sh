...
helm install stationdev ./station -n stationdev -f awsvalue.yaml \
     --set app.stationback.ingress.targetGroupARN="${TG_ARN_STATION_BACK}"  \
     --set app.stationfront.ingress.targetGroupARN="${TG_ARN_STATION_FRONT}" 
